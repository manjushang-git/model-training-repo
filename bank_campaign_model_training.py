...
bucket = storage_client.bucket("mlops-airflow-eg")
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "core-site-401904.ml_ops.bank_campaign_model_metrics"
...
def main():
    input_data_path = "gs://mlops-airflow-eg/bank-campaign-training-data.csv"
    model_name = 'xgboost'
